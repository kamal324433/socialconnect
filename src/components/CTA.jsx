    ...
    <section className="py-24 bg-gradient-to-r from-primary via-indigo-600 to-purple-600 relative overflow-hidden">
      ...
      <div className="container relative z-10">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-5xl font-bold text-white mb-6">Have a Problem Worth Solving?</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="px-8 py-4 bg-white text-primary font-bold rounded-lg hover:bg-gray-100 transition-all flex items-center justify-center shadow-lg hover:shadow-2xl transform hover:scale-105">
              <Zap size={20} className="mr-2" />
              Submit a Challenge
            </button>
            <button className="px-8 py-4 bg-transparent text-white font-bold rounded-lg border-2 border-white hover:bg-white hover:text-primary transition-all flex items-center justify-center">
              Explore Challenges
